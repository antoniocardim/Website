      ...
      >
        ...
        >
          ...
          {status && (
            <div className="mt-4">
              {status === "invalid" && (
                <p className="text-red-600 text-sm text-center">Invalid email address.</p>
              )}
              {status === "already" && (
              ...
              {status === "blocked" && (
                <p className="text-red-600 text-sm text-center">Submission blocked.</p>
              )}
              {status === "success" && (
                <p className="text-green-600 text-sm text-center">Subscribed successfully!</p>
              )}
              {status === "error" && (
